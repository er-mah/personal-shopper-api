...
public class PipedriveService {
    ...
    public Pipeline[] getAllPipelines() {
        try {
            URI url = URI.create(PIPEDRIVE_BASE_URI + "/pipelines?api_token=" + token);
    ...
    public Stage[] getStagesByPipelineId(Long pipelineId) {
        try {
            ...
            URI url = URI.create(PIPEDRIVE_BASE_URI + "/stages?api_token=" + token + "&pipeline_id=" + pipelineId);
            String bearerToken = "Bearer " + getToken();
    ...
    public Stage addStageToPipeline(String name, Long pipelineId) {
        try {
            ...
            URI url = URI.create(PIPEDRIVE_BASE_URI + "/stages?api_token=" + token);
            String bearerToken = "Bearer " + getToken();
    ...
    public Person getPersonByTerm(String term, String type) {
        try {
            ...
            // By DNI
            URI url = URI.create(PIPEDRIVE_BASE_URI + "/persons/search?api_token=" + token + "&term=" + term + "&fields=custom_fields");

            // By name
            if (type.equals("name")) {
                url = URI.create(PIPEDRIVE_BASE_URI + "/persons/search?api_token=" + token + "&term=" + term + "&fields=name");
            }
    ...
    public Person createPerson(String name, String email, String phone, String dni) {
        try {
            ...
            URI url = URI.create(PIPEDRIVE_BASE_URI + "/persons?api_token=" + token);
            String bearerToken = "Bearer " + getToken();
            ...
            values.put(PIPEDRIVE_DNI_HASH, dni);
    ...
    public Deal createDeal(String title, Long personId, Long stageId, String vehicleBrand, Integer vehicleYear, String vehicleModel, String vehicleVersion) {
        try {
            ...
            URI url = URI.create(PIPEDRIVE_BASE_URI + "/deals" + "?api_token=" + token);
            String bearerToken = "Bearer " + getToken();
            ...
            HashMap<String, Object> values = new HashMap<>() {{
                ...
                put("visible_to", 3);
                put(PIPEDRIVE_VEHICLE_BRAND_HASH, vehicleBrand);
                put(PIPEDRIVE_VEHICLE_YEAR_HASH, vehicleYear);
                put(PIPEDRIVE_VEHICLE_MODEL_HASH, vehicleModel);
                put(PIPEDRIVE_VEHICLE_VERSION_HASH, vehicleVersion);
                put(PIPEDRIVE_INPUT_CHANNEL, "Personal Shopper WEB");
            }};
    ...
    public Note addNoteToDeal(String content, Long dealId) {
        try {
            ...
            URI url = URI.create(PIPEDRIVE_BASE_URI + "/notes?api_token=" + token);
            String bearerToken = "Bearer " + getToken();
